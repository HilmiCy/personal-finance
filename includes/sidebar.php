...
<div class="sidebar">
    ...
    <div class="sidebar-nav">
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="/keuangan/pages/analytics/index.php" class="nav-link-sidebar <?= strpos($current_page, 'analytics') !== false ? 'active' : '' ?>" title="Analisis AI">
    ...
    <div class="sidebar-footer">
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="/keuangan/pages/profile/index.php" class="nav-link-sidebar <?= strpos($current_page, 'profile') !== false ? 'active' : '' ?>" title="Profil">
